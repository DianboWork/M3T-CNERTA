...
from module.bilstm_encoder import BiLSTM_Tagging
...
if __name__ == '__main__':
    ...
    data_arg.add_argument('--train_file', type=str, default="./data/new_text/train_25.json")
    ...
    model_arg.add_argument('--text_encoder', type=str, default="BERT")
    model_arg.add_argument('--emb_dim', type=int, default=256)
    model_arg.add_argument('--hidden_dim', type=int, default=300)
    model_arg.add_argument('--lstm_layer', type=int, default=1)
    model_arg.add_argument('--bilstm_flag', type=str2bool, default=True)
    ...
    learning_arg.add_argument('--max_epoch', type=int, default=100)
    learning_arg.add_argument('--gradient_accumulation_steps', type=int, default=1)
    learning_arg.add_argument('--textual_encoder_lr', type=float, default=1e-3)
    ...
    model = BiLSTM_Tagging(args, data)
    if args.use_gpu:
        model = model.cuda()
